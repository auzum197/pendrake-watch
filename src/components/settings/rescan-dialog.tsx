		...
		<AlertDialog open={open} onOpenChange={change}>
			<AlertDialogContent>
				<AlertDialogHeader>
					...
					<AlertDialogDescription>
						Pendrake drops the synced history on this device and scans the
						chain again from block {birthdayHeight.toLocaleString()}. The
						balance and notes rebuild as the scan runs. The Wallet's identity
						and viewing key don't change.
					</AlertDialogDescription>
				</AlertDialogHeader>
