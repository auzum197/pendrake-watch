...
export function DiscreetEye() {
	...
	return (
		<button
			...
			className="flex shrink-0 cursor-pointer items-center text-white/45 transition-colors hover:text-white/80 focus-visible:outline-2 focus-visible:outline-brand"
		>
