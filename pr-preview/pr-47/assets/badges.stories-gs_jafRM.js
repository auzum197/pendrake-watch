import{j as s}from"./iframe-u8QP6QJa.js";import{P as p,a as c,C as l,M as m,S as n}from"./badges-DaeCrlAp.js";import"./preload-helper-PPVm8Dsz.js";const d=["orchard","sapling","transparent"],x={component:p,args:{pool:"orchard"}},a={render:()=>s.jsx("div",{className:"flex gap-2",children:d.map(e=>s.jsx(p,{pool:e},e))})},o={render:()=>s.jsxs("div",{className:"flex gap-2",children:[s.jsx(n,{status:"unspent"}),s.jsx(n,{status:"spent"}),s.jsx(n,{status:"pending"})]})},r={render:()=>s.jsxs("div",{className:"flex gap-2",children:[s.jsx(l,{}),s.jsx(m,{})]})},t={render:()=>s.jsx("div",{className:"flex items-center gap-3",children:d.map(e=>s.jsx(c,{pool:e},e))})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
